...
i2b2.PM.model.html.loginDialog = '<div id="i2b2_login_modal_dialog" style="display:block;">\n'+
	...
	'				<div class="input"><input type="text" name="uname" id="loginusr" value="" size="20" maxlength="50" /></div>\n'+
	'				<div class="label">Password:</div>\n'+
	//TODO IDRT: CHANGE USER
	'				<div class="input"><input type="password" name="pword" id="loginpass" value="" size="20" maxlength="50" /></div>\n'+
